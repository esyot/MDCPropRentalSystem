    ...
    <aside id="sidebar"
        ...
        <div class="flex justify-between items-center flex-col">
            ...
            <div class="flex flex-col items-center">
                ...
                <span id="logoLabel"
                    class="flex justify-center text-white ml-4 text-sm text-center hidden">
            ...
            <div id="menu-items" class="mt-10 space-y-6 flex flex-col transition-transform duration-600 ease">
                ...
                <a href="#" class="w-full p-3 flex items-center text-white hover:text-blue-300 transition duration-200 rounded-lg"
                    title="Manage Roles">
